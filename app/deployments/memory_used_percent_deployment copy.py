...
from app.flows.memory_used_percent import memory_used_percent_flow
...
if __name__ == "__main__":
    ...
    from_source: Flow = memory_used_percent_flow.from_source(
        source=s3_bucket,
        entrypoint="app/flows/memory_used_percent.py:memory_used_percent_flow",
    )

    flow_name = MetricWatcher.Flows.MEMORY_USED_PERCENT_FLOW_NAME
    ...
    flow_uuid = from_source.deploy(
        ...
        description="Docker-based infrastructure flow for Memory monitoring",
    )
